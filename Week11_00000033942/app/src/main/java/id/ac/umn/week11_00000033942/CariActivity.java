...
public class CariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNimCari = findViewById(R.id.etNimCari);
        etNamaCari = findViewById(R.id.etNamaCari);
        etHasilCari = findViewById(R.id.etHasilCari);
        ...
        btnCari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!nim.isEmpty() || !nama.isEmpty()) {
                    ...
                    new AsyncCariMahasiswa().execute(builtURI.toString());
                } else {
                    etHasilCari.setText("NIM dan/atau NAMA harus ada yang di isi");
                }
            }
        });
    }

    class AsyncCariMahasiswa extends AsyncTask<String, Void, String> {
            ...
            try {
                ...
                if (reader != null) {
                    try {
                        ...
                        Log.e("WEBSERVICE1", "Exception: " + e.getMessage().toString());
                    }
                }
            }
            return null;
